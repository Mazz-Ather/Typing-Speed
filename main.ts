    ...
    if(confirm.confirm){
      ...
      if (start.easy) {
        ...
        let  words = start.easy.trim().split(/\s+/);
          ...
          console.log(`you write ${num} corrected words out of ${sentence.length} in ${totalTime} seconds`);
        ...
        let  word = star.medium.trim().split(/\s+/);
         ...
         let floor = Math.floor((word / totalTime)* 60)
          ...
          if(num >= 12) {
            ...
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 75)}%`);
          }else if(num >= 8){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 65)}%`);
          }else if(num >= 6){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 55)}%`);
          }else if(num >= 4){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 40)}%`);
          }else if(num >= 2){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 20)}%`);
          }else if(num >= 1){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 )}%`);
          }else{
            console.log(`your percentage according to your typing skill is 0%`);
          }
      return num;
...
async function handleAdvance() {
  ...
  console.log("Prepare for a longer sentence with intricate wording and punctuation to push your typing skills to the limit!\n and remember this is also a case sensitive");
  console.log("----------------------------------------------------------------------------------------------");
        ...
        let  word = star.hard.trim().split(/\s+/);
         ...
         let floor = Math.floor((word / totalTime)* 60)
          ...
          if(num >= 38) {
            ...
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 85)}%`);
          }else if(num >= 32){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 75)}%`);
          }else if(num >= 26){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 65)}%`);
            ...
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 45)}%`);
          }else if(num >= 14){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 35 )}%`);
          }else if(num >= 10){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 35 )}%`);
          }else if(num >= 8){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 25 )}%`);
          }else if(num >= 5){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 15 )}%`);
          }else if(num >= 3){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 + 5 )}%`);
          }else if(num >= 1){
            console.log(`your percentage according to your typing skill is ${Math.floor(Math.random() * 10 )}%`);
          }else{
            console.log(`your percentage according to your typing skill is 0%`);
  ...
  console.log("***************************************************************************************************************************");
  console.log("Due to its complexity, the advanced-level sentence won't be displayed here. However, get ready for a challenge!*")
  console.log("***************************************************************************************************************************");
  await handleAdvance()
}else{
  process.exit()
